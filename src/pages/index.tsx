export default function IndexPage() {
    return (
        <>
            ...
            <div className="fixed w-full bg-orange-400 text-white z-10 text-xs md:text-sm p-2">
                <div className="max-w-5xl mx-auto text-center">
                    <p><b>Call today:</b> (239) 888 0092</p>
                </div>
            </div>

            <div className="bg-blue-500 text-white w-full h-auto px-6 py-24 md:py-48">
                <div className="max-w-5xl mx-auto space-y-8">
                    <img className="w-32 md:w-48" src="/img/duck.png" alt="" />
                    <div className="space-y-4">
                        <p className="text-4xl md:text-6xl font-bold">Window washing done right.</p>
                        <p className="text-3xl md:text-5xl font-bold"> Now serving the <span className="bg-orange-400">Golden Gate Estates</span>.</p>
                    </div>
                    <p className="opacity-50 text-2xl">Using next-generation bladed technology, transform your homes windows into clear-cut ullamco est nisi anim consectetur aliqua fugiat ea Lorem pariatur enim laboris aute id. Exercitation sint ullamco dolor amet ipsum ea occaecat sit.</p>
                </div>
            </div>

            <div className="bg-gray-100 p-6 pb-24 space-y-12">
                <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div className="bg-white shadow-xl rounded p-6 space-y-2">
                        <p className="text-2xl font-extrabold text-blue-400">Fast</p>
                        <p className="opacity-50 text-lg">Book your appointment in under 2 minutes and forget. Poof. Windows are clean. Like it was done by some ninjas.</p>
                    </div>
                    <div className="md:-mt-12">
                        <div className="bg-white shadow-xl rounded p-6 space-y-2">
                            <p className="text-2xl font-extrabold text-pink-400">Friendly</p>
                            <p className="opacity-50 text-lg">Run by humans who live next-door to you, we strive to give you a pleasent and memorable experience.</p>
                        </div>
                    </div>
                    <div className="bg-white shadow-xl rounded p-6 space-y-2">
                        <p className="text-2xl font-extrabold text-indigo-400">Familiar</p>
                        <p className="opacity-50 text-lg">Ducky Windows is a 100% family-owned company based in right at home — in the heart of the Golden Gate Estates.</p>
                    </div>
                </div>
                ...
                <div className="flex items-center justify-center">
                    <div className="space-y-4">
                        <div className="text-center">
                            <p className="opacity-30 text-sm uppercase font-medium">Based in the Golden Gate Estates</p>
                            <p className="opacity-50 uppercase font-bold">Naples, Bonita Springs, and Beyond</p>
                        </div>
                        <div className="text-center space-y-4">
                            <a className="inline-block bg-orange-400 border-b-4 border-orange-600 shadow-xl text-orange-700 text-3xl font-medium px-8 py-4 rounded-2xl" href="#">Book now!</a>
                        </div>
                    </div>
                </div>
            </div>
